var app = angular.module('epUserApp', []);

app.controller('MainController', function($scope, $http) {
    $http.get("http://localhost:8083/HibernateApps/EpUser/all")
    .then(function(response) {
        $scope.epUsers = response.data;
    });
});

/*app.factory('Person', ['$resource', function ($resource) {
    return $resource('http://localhost:8083/HibernateApps/EpUser/:epUserId', {epUserId: '@pid'},
	{
